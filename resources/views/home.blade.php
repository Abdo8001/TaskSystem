                                        ...
                                        <td> <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                    data-target="#edit{{ $task->id }}" title="editStatus"><i
                                                        ...
                                                        {{-- <td>  <a class="btn btn-outline-info btn-sm"
                                                            href="{{url('download_photo')}}/{{ $task->id }}/{{$task->images->filename}}"
                                                            role="button"><i class="fas fa-download"></i>&nbsp; download task</a></td> --}}
                                                            {{-- <td>  <a class="dropdown-item"
                                                                href="{{ route('tasks.show', $task->id) }}"><i
                                                                    style="color: #ffc107" class="far fa-eye "></i>&nbsp;
                                                                show task</a></td> --}}
                                    ...
                                    <div class="modal fade" id="edit{{ $task->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- add_form -->
                                                    <form action="{{ route('task.user', 'test') }}" method="POST">
                                                        @csrf
                                                        @method('patch')
                                                        <div class="row">
                                                            <div class="col">
